...
var answers = ["Yeah dawg", "Maybe homie", "Nah son"];

function magic8baller() {
  var question = prompt("Ask a question cuz...");
  var magicNum = Math.floor(Math.random()*3);
  document.getElementById("output").innerHTML = answers[magicNum];
